...
export async function updateKesehatanUpdate(id: number, data: any) {
  ...
  await sql`
    UPDATE kesehatan_update SET
      ...
      tgl_pemeriksaan_anak = ${data.tgl_pemeriksaan_anak || null},
      tgl_pemeriksaan_ibu = ${data.tgl_pemeriksaan_ibu || null},
      tgl_pemeriksaan_lansia = ${data.tgl_pemeriksaan_lansia || null},
      anak_tgl_lahir = ${data.anak_tgl_lahir || null},
      anak_bb_lahir = ${data.anak_bb_lahir || 0},
      anak_tinggi_badan = ${data.anak_tinggi_badan || 0},
      anak_berat_badan = ${data.anak_berat_badan || 0},
      anak_nama_ibu = ${data.anak_nama_ibu},
      anak_ke = ${data.anak_ke || 0},
      anak_pendampingan_khusus = ${data.anak_pendampingan_khusus},
      anak_asi_eksklusif = ${data.anak_asi_eksklusif || 0},
      anak_metode_pengukuran = ${data.anak_metode_pengukuran},
      anak_lingkar_kepala = ${data.anak_lingkar_kepala || 0},
      ...
      ibu_tgl_lahir = ${data.ibu_tgl_lahir || null},
      ibu_bb_sebelum_hamil = ${data.ibu_bb_sebelum_hamil || 0},
      ibu_tinggi_badan = ${data.ibu_tinggi_badan || 0},
      ibu_berat_badan = ${data.ibu_berat_badan || 0},
      ibu_lila = ${data.ibu_lila || 0},
      ibu_umur_kehamilan = ${data.ibu_umur_kehamilan || 0},
      ibu_hb = ${data.ibu_hb},
      ibu_imunisasi = ${JSON.stringify(data.ibu_imunisasi || [])},
      lansia_tgl_lahir = ${data.lansia_tgl_lahir || null},
      lansia_tinggi_badan = ${data.lansia_tinggi_badan || 0},
      lansia_berat_badan = ${data.lansia_berat_badan || 0},
      lansia_tekanan_darah = ${data.lansia_tekanan_darah},
      lansia_kolesterol = ${data.lansia_kolesterol || 0},
      lansia_gula = ${data.lansia_gula || 0},
      lansia_asam_urat = ${data.lansia_asam_urat || 0},
