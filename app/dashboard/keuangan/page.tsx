    ...
    <div className="p-4 lg:p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="col-span-1 lg:col-span-4 space-y-4">
          <div className="bg-teal-700 rounded-xl p-5 text-white shadow-sm flex flex-col justify-between h-full">
            <div>
            ...
            <div className="mt-6 flex flex-col gap-3">
              <div className="bg-teal-800/50 p-3 rounded-lg border border-teal-600/50">
        ...
        <div className="col-span-1 lg:col-span-8">
          <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 font-mono text-lg"
                    placeholder="0"
                    required
                  />
                </div>
              ...
              <div className="space-y-2 pt-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-slate-500 truncate min-w-0 flex-1">
                    {formData.bukti_url ? <a href={formData.bukti_url} target="_blank" className="text-teal-600 hover:underline flex items-center gap-1"><FileImage className="w-4 h-4" /> Lihat Bukti</a> : 'Belum ada file terpilih'}
                  </span>
                </div>
              </div>
            ...
            <div className="pt-6 border-t flex justify-end">
              <Button type="submit" disabled={loading || uploading} className="bg-teal-600 hover:bg-teal-700 px-6">
